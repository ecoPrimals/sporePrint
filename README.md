...
- **`spore-validate`** — Rust validation + certification crate (28 modules, 258 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 28 modules, 258 tests, zero C toolchain
...
zero warnings, 258 tests, zero C toolchain dependencies. Edition 2024, Rust 1.85+. Release binary optimized (LTO+strip).
...
### Current — Wave 133a (July 6, 2026)
- 226 content pages, 66 entities, 258 tests, 28 modules
