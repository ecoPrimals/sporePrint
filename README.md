...
- **`spore-validate`** — Rust validation + certification crate (15 modules, 101 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 15 modules, 101 tests, zero C toolchain
...
zero warnings, 101 tests, zero C toolchain dependencies.
