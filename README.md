...
- **`spore-validate`** — Rust validation + certification crate (27 modules, 220 tests, zero C deps)
...
### Current — Wave 132d (July 4, 2026)
- 222 content pages, 66 entities, 220 tests, 27 modules
