...
- **`spore-validate`** — Rust validation + certification crate (24 modules, 187 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 24 modules, 187 tests, zero C toolchain
...
zero warnings, 187 tests, zero C toolchain dependencies. Edition 2024, Rust 1.85+. Release binary optimized (LTO+strip).
...
- 222 content pages, 66 entities, 187 tests, 24 modules
