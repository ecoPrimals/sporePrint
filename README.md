...
- **`spore-validate`** — Rust validation + certification crate (21 modules, 150 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 21 modules, 150 tests, zero C toolchain
...
zero warnings (pedantic+nursery), 150 tests, zero C toolchain dependencies. Release binary optimized (LTO+strip).
