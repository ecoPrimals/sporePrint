...
- **`spore-validate`** — Rust validation + certification crate (26 modules, 198 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 26 modules, 198 tests, zero C toolchain
...
zero warnings, 198 tests, zero C toolchain dependencies. Edition 2024, Rust 1.85+. Release binary optimized (LTO+strip).
