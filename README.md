...
- **`spore-validate`** — Rust validation + certification crate (25 modules, 193 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 25 modules, 193 tests, zero C toolchain
...
zero warnings, 193 tests, zero C toolchain dependencies. Edition 2024, Rust 1.85+. Release binary optimized (LTO+strip).
...
- 222 content pages, 66 entities, 193 tests, 25 modules
