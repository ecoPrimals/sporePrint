...
- **`spore-validate`** — Rust validation + certification crate (24 modules, 183 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 24 modules, 183 tests, zero C toolchain
...
zero warnings, 183 tests, zero C toolchain dependencies. Edition 2024, Rust 1.85+. Release binary optimized (LTO+strip).
...
### Current — Wave 120 (June 20, 2026)
- 222 content pages, 66 entities, 183 tests, 24 modules
