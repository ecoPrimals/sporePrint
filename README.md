...
- **`spore-validate`** — Rust validation + certification crate (33 modules, 279 tests, zero C deps)
...
├── crates/
│   └── spore-validate/  # Rust crate: 33 modules, 279 tests, zero C toolchain
...
zero warnings, 279 tests, 33 modules, zero C toolchain dependencies. Edition 2024, Rust 1.85+. Release binary optimized (LTO+strip). All files under 620L (max: content.rs at 616).
...
- 259 content pages, 66 entities, 279 tests, 33 modules
