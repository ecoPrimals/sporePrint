...
| Check prior art and licensing | [Sovereign Prior Art](@/architecture/SOVEREIGN_PRIOR_ART_CATALOG.md) — AGPL analysis per primal |
| See how springs feed products | [Composition Pipeline](@/architecture/COMPOSITION_PIPELINE.md) — springs → compositions → products → foundation |
