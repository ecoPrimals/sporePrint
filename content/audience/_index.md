+++
title = "🧭 Audience"
description = "Find your path into ecoPrimals — guides for faculty, students, builders, and compliance reviewers."
sort_by = "title"
template = "section.html"
+++

Different readers need different entry points. Pick the one that matches your role:

| If you are... | Start here |
|---|---|
| **A PI or faculty member** evaluating this for your lab | [For Faculty and PIs](@/audience/FOR_FACULTY_AND_PIS.md) — what ecoPrimals replaces, what it costs, how it compares to institutional HPC |
