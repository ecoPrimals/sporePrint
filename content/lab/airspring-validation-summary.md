...
description = "Precision agriculture & irrigation — 1,446 Rust tests, 90 experiments, 10 UniBin validation scenarios, 57 registered / 46 live capabilities, eastGate operational, zero failures"
date = 2026-06-10
...
- [Spring Catalog](https://sporeprint.primals.eco/architecture/spring-catalog-status-science-and-evolution/) on primals.eco
- [Lab Notebooks](https://sporeprint.primals.eco/lab/notebooks/) for rendered notebook views
- [baseCamp Papers](https://sporeprint.primals.eco/science/) (Dong lab, FAO-56, Richards, Stewart)
