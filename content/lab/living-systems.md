...
| **flockGate** | WAN only | WG via golgi (72ms p50) | Tower atomic, **esotericWebb V19.1 LIVE** (:8090, systemd), songBird, bearDog, skunkBat |
...
| `esotericwebb.serve` | flockGate | **LIVE** — [webb.primals.eco](https://webb.primals.eco) (200, 235ms) |
