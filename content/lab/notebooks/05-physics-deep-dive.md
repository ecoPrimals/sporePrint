...
description = "Rendered from 05-physics-deep-dive.ipynb — live notebook from the ABG shared workspace"
date = 2026-05-30
weight = 50
...
<!-- Re-render with: bash scripts/render_notebooks.sh --notebook /tmp/source-repo/notebooks/05-physics-deep-dive.ipynb -->
