...
<pre>/tmp/ipykernel_2902/4200604355.py:22: RuntimeWarning: overflow encountered in scalar multiply
  self.state = self.state * LCG_MUL + LCG_INC
/tmp/ipykernel_2902/4200604355.py:22: RuntimeWarning: overflow encountered in scalar add
  self.state = self.state * LCG_MUL + LCG_INC
</pre>
</div>
</div>
