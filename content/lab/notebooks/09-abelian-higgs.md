...
<pre>/tmp/ipykernel_2926/4200604355.py:22: RuntimeWarning: overflow encountered in scalar multiply
  self.state = self.state * LCG_MUL + LCG_INC
/tmp/ipykernel_2926/4200604355.py:22: RuntimeWarning: overflow encountered in scalar add
  self.state = self.state * LCG_MUL + LCG_INC
</pre>
</div>
</div>
...
<div class="output_area">
<div class="output_subarea output_stream output_stdout output_text">
<pre>  Higgs condensed       plaq=0.926801  |phi^2|=4.4227  acc=92%  1.2s
</pre>
</div>
</div>
<div class="output_area">
