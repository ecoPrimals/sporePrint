+++
title = "scyBorg Exception Protocol"
description = "Symbiotic licensing: how primals and springs can grant reciprocal exceptions under the scyBorg triple-copyleft framework — lysogeny, partnership, and mutual benefit."
weight = 7
date = 2026-07-09
...
**Status**: Active
**Companion**: [scyBorg Licensing](@/methodology/SCYBORG_LICENSING.md), `wateringHole/LYSOGENY_PROTOCOL.md`, [I Own Nothing](@/philosophy/i_own_nothing.md)
...
- [scyBorg Licensing](@/methodology/SCYBORG_LICENSING.md) — scyBorg triple license framework; full licensing strategy
- `wateringHole/LYSOGENY_PROTOCOL.md` — area denial strategy
- [Glossary](@/glossary/_index.md) — ecosystem terminology
- [I Own Nothing](@/philosophy/i_own_nothing.md) — the ownership inversion; philosophical companion essay
...
- [scyBorg Licensing](@/methodology/SCYBORG_LICENSING.md) — triple-copyleft framework (AGPL + ORC + CC-BY-SA)
- [For Compliance and Institutional Review](@/audience/FOR_COMPLIANCE_AND_INSTITUTIONAL_REVIEW.md) — licensing posture for institutional audiences
- [The Temptation of Kingdoms](@/philosophy/the_temptation_of_kingdoms.md) — why the commons persists regardless of exceptions
