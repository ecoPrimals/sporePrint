...
1. A resource or capability exists independent of the mediator
2. The mediator positions himself between people and the resource
3. The mediation extracts value proportional to the dependency it creates
4. The dependency is maintained by making alternatives appear impossible
...
*See also: [I Own Nothing](@/philosophy/i_own_nothing.md) — the economic inversion. [The Mobility Edge](@/philosophy/the_mobility_edge.md) — how sovereign networks grow despite kingdoms.*
