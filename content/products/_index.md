...
"Product" here means **chemical reaction product** — what emerges when you
combine primals. These are not commercial software for sale. helixVision is
what happens when barraCuda (math) + coralReef (compiler) + toadStool
(dispatch) + NestGate (storage) are composed and pointed at genomic data.
