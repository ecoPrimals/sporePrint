...
- **32⁴ SU(3) PRODUCTION COMPLETE** — 45/45 cross-vendor configs, literature ~0.3%, cross-GPU Δ=0.19%
- **arXiv 41/42** — physics DONE, reviewer send blocked on primals.eco operability
- **Normalization RESOLVED** — gauge-group mismatch (SU(3) vs SU(2) literature), not a bug
- **Lattice capacity**: 22⁴→73⁴ dual GPU (121× more sites). Streaming encoder shipped.
...
- **Normalization RESOLVED** — code was SU(3) all along; ×4 discrepancy was gauge-group mismatch
- **Cross-vendor 0.19%** at β=6.20, 32⁴ (AMD vs NVIDIA)
- **Lattice capacity 73⁴** dual GPU (121× more sites, software guard bypass)
- **10 pages refreshed** — QCD pseudoSpore cluster, infrastructure pages, data volumes
- **3.21→3.3 TB** — data volume corrected across pseudospore + data catalog pages
- **living-systems.md** — rewritten for 12 gates, 6 NUCLEUS, Wave 157k backlog
- **MESH_TOPOLOGY.md** — rewritten for 12 gates, 6 NUCLEUS, graftGate/iosGate/steamGate
- **SOVEREIGN_CI.md** — updated to Wave 157k, 3/3 builders, 4-arch depot
