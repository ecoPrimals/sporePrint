...
2. `KNOWLEDGE_TOPOLOGY.md` — intellectual foundations: how information connects (Diderot, Bush, Nelson)
3. `CONTENT_VOICE.md` — how to write: narrative standards, replication framing, metric conventions
4. `TAXONOMY_STANDARD.md` — how entity references and build-time validation work
5. `TEMPLATE_GUIDE.md` — how templates, layouts, and sections work
6. `CONTENT_MAP.md` — what exists, what may be stale, cross-section dependencies
7. `EVOLUTION_QUEUE.md` — what needs doing next
...
| `KNOWLEDGE_TOPOLOGY.md` | Intellectual lineage — Diderot, Bush, Nelson → typed entity graph | Before adding edges or connections |
